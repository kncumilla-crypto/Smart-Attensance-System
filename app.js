...
// ==================== APP INITIALIZATION ====================
console.log('Attendance System v3.1.2 - Initializing...');
...
window.addEventListener('load', function() {
    ...
    if (typeof CryptoJS === 'undefined') {
        ...
        showNotification('Error: Security library not loaded. Please check your internet connection.', 'error', 10000);
        return;
    }
    
    if (typeof XLSX === 'undefined') {
        console.error('XLSX library not loaded!');
        showNotification('Error: Excel export library not loaded. Please check your internet connection.', 'error', 10000);
        return;
    }
...
function initializeApp() {
    ...
    try {
        ...
        // Show welcome screen for 3 seconds then check auto-login
        setTimeout(() => {
            const welcomeScreen = document.getElementById('welcomeScreen');
            if (welcomeScreen) {
                welcomeScreen.classList.add('hidden');
